...
Interested: positive score from provided settled profile artifact, freshness window. Cold start: public topic-config match if policy explicitly selects fallback, reason clearly says shared topics and no personal profile. Do not fabricate a profile revision.
