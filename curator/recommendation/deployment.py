...
# 120, not 15. The provider request deadline alone is 25s and the claimed
# section may spend another 85s on Supabase round trips, so a 15s container was
