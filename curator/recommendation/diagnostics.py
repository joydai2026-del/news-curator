...
KNOWN_DIAGNOSTIC_MESSAGES = frozenset({
    ...
    'next_run_preparation.enabled and NEWS_CURATOR_MODAL_PREPARATION_WORKER_ENABLED must match',
    'next_run_preparation.enabled must be boolean in the staged policy',
    'preparation worker returned an invalid outcome',
    'prepared scrub returned an invalid count',
    ...
    'invalid general candidate query',
    ...
    'next_run_preparation contains unknown keys',
    ...
    'opened candidate lookup exceeds protocol limit',
